...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="<?= BASE_URL; ?>" class="logo me-auto"><img src="assets/img/logo.png" alt=""></a>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon"><i class="fas fa-heartbeat"></i></div>
            <h4 class="title"><a href="">Hentikan Perbudakan Modern di Laut</a></h4>
            <p class="description">Tak jarang ABK Indonesia menjadi korban perbudakan modern di kapal perikanan asing jarak jauh. Bagaimana perlindungan dari Pemerintah?</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon"><i class="fas fa-pills"></i></div>
            <h4 class="title"><a href="">Pulihkan Perairan Karawang dari Minyak</a></h4>
            <p class="description">Sudah dua tahun berturut-turut petaka tumpahan minyak Pertamina terjadi di perairan Indonesia. Kenapa?</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon"><i class="fas fa-hospital-user"></i></div>
            <h4 class="title"><a href="">Selamatkan Karimunjawa</a></h4>
            <p class="description">Lindungi Taman Nasional Karimunjawa dari kerusakan akibat transportasi tongkang batu bara ilegal yang merusak terumbu karang</p>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box">
                  <i class="bx bx-map"></i>
                  <h3>Alamat Kami</h3>
                  <p>Jalan Ahmad Yani No. 50, Jakarta Pusat</p>
                </div>
              </div>
              <div class="col-md-6">
